...
> **Note:** When live GCP pricing is added (see [#231](https://github.com/cloudpilot-ai/karpenter-provider-gcp/pull/231)),
> `cloudbilling.services.get` and `cloudbilling.skus.list` will need to be added to
> `deploy/iam/karpenter-controller-role.yaml`. This guide will be updated at that point.
